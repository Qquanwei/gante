...
const Contribute: React.FC<IContributeProps> = ({ className, contributes }) => {
  return (
    <div className={classNames(className, 'p-4 bg-stone-500 text-white rounded-[10px]')}>
      ...
      <div>
        本站的长期运营离不开朋友们的支持，为了支持本站更好的发展，目前开启捐赠渠道，主要用于支付服务器维护成本，支持本站提供更优质的服务。本站点维护模式主要靠捐赠为主，不会限制访问和使用（本站初心），如果你喜欢这款小而美的软件，可以以捐赠的形式参与到本站的建设，
        捐赠者会永久出现在本站捐赠者名单中。
      </div>
      <div className="mt-2">
      ...
      <div>
        <div className="mt-2 bg-[url(/alipay-qrcode.jpg)] bg-no-repeat bg-contain bg-left-center w-[500px] h-[400px] rounded-[5px]">
        </div>
      </div>
