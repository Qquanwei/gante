        ...
        <div>
            ...
            <Modal show={showLoginModal} onClose={onModalClose}>
                ...
                <div className="flex items-center justify-center flex-col mx-auto mt-[20px] w-[300px]">
                    ...
                    <a className="github-login block w-full mt-[10px] h-[36px]" target="_blank" noreferer="true" href="https://github.com/login/oauth/authorize?login&client_id=c7b4ad0b9f7f6b38da81" >
                        Github
                    </a>
                </div>
            </Modal>
