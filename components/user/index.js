    ...
    <div>
      ...
      <Modal show={showLoginModal} onClose={onModalClose}>
        ...
        <div className="flex items-center justify-center flex-col mx-auto mt-[20px] w-[300px]">
          ...
          <a className="github-login block border flex items-center justify-center hover:bg-gray-300 w-full mt-[10px] h-[36px]" noreferer="true" href={`https://github.com/login/oauth/authorize?login&client_id=${process.env.GANTE_GITHUB_CLIENT_ID}&scope=user`} >
            Github
          </a>
        </div>
      </Modal>
