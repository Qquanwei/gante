  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Gante是一款稳定高效的项目管理工具, 可靠，稳定，高效，免费！"
        />
        <link rel="icon" href="/favicon.ico" />
        <meta
          name="google-signin-client_id"
          content="499253238732-j69pk534uht0ce1h8vg1ts8epak5rgm8.apps.googleusercontent.com"
        />
        <meta
          name="keywords"
          content="甘特图,个人甘特图,甘特图工具,在线甘特图,项目管理工具"
        />
      ...
      <main className="overflow-hidden min-h-[100vh] text-black bg-[#fbfbfb] font-mono ">
        ...
        <div className="text-[30px] text-center mt-[100px]">
          ...
          <h1 className="text-[#444] text-[20px]">
            免费管理你自己的项目进度、日程安排
          </h1>
        </div>
          ...
          <div className="flex justify-center mt-5 items-center">
            {user ? (
              <Link href={`/editor?id=${user?.defaultTableId}`}>
                <div className="ml-4 p-4 border border-black  mr-4 border-box text-[20px] block box-border rounded-lg hover:text-sky-500">
                  进入我的Gante工具
                </div>
              </Link>
            ) : (
            ...
            <div className="ml-4 cursor-pointer hover:text-sky-500">
              <Link href="/editor?id=guest">在线体验</Link>
            </div>
          </div>
              ...
              <div className="w-[500px] text-center shrink-0 items-center">
                <div className="text-left pt-10 text-[14px] pl-[20px] items-center">
                  ...
                  <div className="mt-10">
                    通过
                    <Link
                      href="https://github.com/Qquanwei/gante"
                      className="mx-2"
                    >
                      点击这里
                    </Link>
