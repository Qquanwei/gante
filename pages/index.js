          ...
          <div className="flex justify-center mt-5 items-center">
            {
              user ? (
                ...
                <div className="mx-2 border-2 border-sky-500 rounded-md px-2 flex items-center">
                  <span>+86</span>
                  <input className="mx-2 p-2 focus:outline-none rounded h-[50px] w-[160px]" name="" type="text" />
                  <div className="ml-2 flex items-center cursor-pointer select-none hover:text-sky-500">立即登录</div>
                </div>
              )
            }
